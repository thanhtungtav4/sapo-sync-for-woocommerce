...
final class Privacy
{
	...
	public static function register(): void
	{
		...
		$content = '<p>' . esc_html__('Inventory Bridge for Sapo transfers only the WooCommerce order, customer, product and inventory data required by the Sapo connection configured by the site administrator. The plugin does not add analytics, advertising, tracking pixels or telemetry.', 'sapo-sync-for-woocommerce') . '</p>';
		...
		wp_add_privacy_policy_content(
			esc_html__('Inventory Bridge for Sapo', 'sapo-sync-for-woocommerce'),
			$content
		);
	}
}
